...
Η υδάτινη κρίση της Κύπρου είναι πραγματική — αλλά δεν είναι ομοιόμορφα κατανεμημένη. Ενώ η νότια ακτή παραμένει υπό έλλειψη και η Αχνά βρίσκεται στο 2%, μια διαφορετική ιστορία εκτυλίσσεται στους λόφους βόρεια του Τροόδους. Στις 30 Μαρτίου 2026, πέντε φράγματα που εξυπηρετούν τη Λευκωσία και το δίκτυο επαναφόρτισης υπόγειων υδάτων του νησιού βρίσκονται όλα στο **100% χωρητικότητας**. Για αυτή την περιοχή, η ξηρασία έχει τελειώσει.

### Τα πέντε φράγματα: η τρέχουσα εικόνα

| Φράγμα | Χωρητικότητα (εκ. m³) | 30 Μαρτίου 2026 | Πέρυσι (30 Μαρτίου) |
|--------|----------------------|-----------------|----------------------|
...
Η αντίθεση με το νότο είναι έντονη. Στις 30 Μαρτίου:
...
*Δεδομένα: Τμήμα Αναπτύξεως Υδάτων Κύπρου, αναφορά 30 Μαρτίου 2026. Ημερήσια ενημέρωση δεδομένων φραγμάτων στο [fragmata.info](https://fragmata.info/).*
