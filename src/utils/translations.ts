export const translations = {
  en: {
    ...
    inflowLabel: "Inflow",
    inflowLast24h: "Last 24h",
    inflowLast7d: "Last 7 days",
    inflowSinceOct: "Since Oct 1",
    fullyDrainedByShort: "Fully Drained By",
    searchReservoirs: "Search reservoirs...",
    filter: "Filter",
    filterByRegion: "Filter by Region",
    allRegions: "All Regions",
    noReservoirs: "No reservoirs match your search criteria",
    
    // Drain dates
    alreadyEmpty: "Already Empty",
    notDraining: "Not Draining",
    beyondTenYears: "Beyond 10 Years",
  ...
  el: {
    ...
    inflowLabel: "Εισροή",
    inflowLast24h: "Τελ. 24ω",
    inflowLast7d: "Τελ. 7 ημ.",
    inflowSinceOct: "Από 1 Οκτ",
    ...
    chrysochou: "Χρυσοχού",
    nicosia: "Λευκωσία",
    rechargeOther: "Εμπλουτισμός/Άλλα",
    ...
    Lefkara: "Λεύκαρα",
    Dipotamos: "Διπόταμος",
    Germasoyeia: "Γερμασόγεια",
    Arminou: "Αρμίνου",
    Polemidia: "Πολεμίδια",
    Achna: "Άχνα",
    Asprokremmos: "Ασπρόκρεμμος",
    Kannaviou: "Κανναβιού",
    Mavrokolympos: "Μαυροκόλυμπος",
    Evretou: "Ευρέτου",
    Argaka: "Αργάκα",
    Pomos: "Πόμος",
    ...
    Tamassos: "Ταμασός",
    "Klirou-Malounta": "Κλήρου-Μαλούντα",
    Solea: "Σολέα",
    
    // Monthly Inflow
    monthlyInflow: "Μηνιαία Εισροή",
  ...
  ru: {
    ...
    inflowLabel: "Приток",
    inflowLast24h: "За 24ч",
    inflowLast7d: "За 7 дн.",
    inflowSinceOct: "С 1 Окт",
  ...
  tr: {
    ...
    // Reservoir names (Turkish forms from Kıbrıs Türk media, Ottoman records, and KKTC official names)
    Kouris: "Kuris",
    Kalavasos: "Kalavason",
    Lefkara: "Lefkara",
    Dipotamos: "İkidere",
    Germasoyeia: "Yermasoya",
    Arminou: "Arminu",
    Polemidia: "Polemidya",
    Achna: "Düzce",
    Asprokremmos: "Asprokremmo",
    Kannaviou: "Kannaviyu",
    Mavrokolympos: "Mavrokolimbo",
    Evretou: "Evretu",
    Argaka: "Argaka",
    Pomos: "Pomos",
    "Agia Marina": "Aya Marina",
    Vyzakia: "Vizakya",
    Xyliatos: "Ksilatu",
    Kalopanagiotis: "Kalapanayot",
    Tamassos: "Tamasu",
    "Klirou-Malounta": "Kliru-Malunta",
    Solea: "Solea",
