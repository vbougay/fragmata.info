...
export const reservoirData: Reservoir[] = [
  ...
  // Recharge/Other
  { name: "Tamassos", capacity: 2.8, inflow: { last24Hours: 0.0, totalSince: 2.650 }, storage: { current: { amount: 2.796, percentage: 99.9 }, lastYear: { amount: 0.882, percentage: 31.5 } }, maxStorage: { amount: 1.069, date: "13/3" }, region: "Recharge/Other" },
  { name: "Klirou-Malounta", capacity: 2.0, inflow: { last24Hours: 0.001, totalSince: 1.121 }, storage: { current: { amount: 2.000, percentage: 100.0 }, lastYear: { amount: 1.399, percentage: 70.0 } }, maxStorage: { amount: 1.473, date: "27/3" }, region: "Recharge/Other" },
  { name: "Solea", capacity: 4.454, inflow: { last24Hours: 0.0, totalSince: 2.636 }, storage: { current: { amount: 4.410, percentage: 99.0 }, lastYear: { amount: 2.671, percentage: 60.0 } }, maxStorage: { amount: 3.012, date: "13/3" }, region: "Recharge/Other" },
];

// Yearly inflow data — updated with 25/26 data through June 10, 2026
...
export const getReportDate = (): string => "10-JUN-2026";
...
export const getDamSummary = (damName: string, language: 'en' | 'el' | 'ru' = 'en'): string | null => {
  const summaries: Record<string, Record<'en' | 'el' | 'ru', string>> = {
    'Kouris': {
      en: 'Kouris at 41.9% (48.2 MCM) — plateau at season high for 12 days, 24.1pp above last year\'s 17.8%. Arminou→Kouris transfer: 20.26 MCM since October.',
      el: 'Ο Κούρης στο 41.9% (48.2 ΕΚΜ) — οροπέδιο στο μέγιστο σεζόν για 12 ημέρες, 24.1μ.π. πάνω από πέρυσι (17.8%). Μεταφορά Αρμίνου→Κούρης: 20.26 ΕΚΜ.',
      ru: 'Курис на 41.9% (48.2 МКМ) — плато у сезонного максимума 12 дней подряд, +24.1пп выше прошлогодних 17.8%. Перекачка Арминоу→Курис: 20.26 МКМ.',
    },
    'Kalavasos': {
    ...
    'Evretou': {
      en: 'Evretou at 50.0% (12.0 MCM) — holding at half capacity, 28.2pp above last year\'s 21.8%. Slow drawdown continues.',
      el: 'Ο Εύρετου στο 50.0% (12.0 ΕΚΜ) — παραμένει στο μισό, 28.2μ.π. πάνω από πέρυσι (21.8%). Αργή μείωση συνεχίζεται.',
      ru: 'Эвретоу на 50.0% (12.0 МКМ) — удерживается на половине, +28.2пп выше прошлогодних 21.8%. Медленный спад продолжается.',
    },
    'Argaka': {
    ...
    'Tamassos': {
      en: 'Tamassos at 99.9% (2.80 MCM) — essentially full, easing slightly. Was 31.5% last year — 3× year-over-year recovery.',
      el: 'Ο Ταμασός στο 99.9% (2.80 ΕΚΜ) — ουσιαστικά πλήρης, ελαφρά υποχωρεί. Από 31.5% πέρυσι — 3× ΕΤΕ.',
      ru: 'Тамассос на 99.9% (2.80 МКМ) — фактически полон, слегка снижается. Год назад 31.5% — восстановление в 3×.',
    },
    'Klirou-Malounta': {
      en: 'Klirou-Malounta full at 100% (2.0 MCM), overflowing since late March. Up from 70.0% last year.',
      el: 'Η Κλήρου-Μαλούντα γεμάτη στο 100% (2.0 ΕΚΜ), υπερχείλιση από τέλη Μαρτίου. Αύξηση από 70.0% πέρυσι.',
      ru: 'Клиру-Малунта заполнена на 100% (2.0 МКМ), переливается с конца марта. Рост с 70.0% год назад.',
    },
    'Solea': {
      en: 'Solea at 99.0% (4.41 MCM) — holding near full as dry season progresses. Up from 60.0% last year — 1.65× year-over-year improvement.',
      el: 'Η Σολέα στο 99.0% (4.41 ΕΚΜ) — παραμένει κοντά στο μέγιστο. Αύξηση από 60.0% πέρυσι — 1.65× βελτίωση ΕΤΕ.',
      ru: 'Солеа на 99.0% (4.41 МКМ) — удерживается вблизи полного уровня. Рост с 60.0% год назад — улучшение в 1.65×.',
    },
  };
...
export const getSummaryChanges = (language: 'en' | 'el' | 'ru' = 'en'): string => {
  if (language === 'el') {
    return `
### Πρόσφατες Αλλαγές (29 Μαΐου — 10 Ιουνίου 2026)

Συνολική αποθήκευση **42.4%** (123.3 ΕΚΜ), αμετάβλητη για **12 συνεχόμενες ημέρες** — η ξηρή περίοδος έχει πλήρως εδραιωθεί. **+21.4μ.π. πάνω από πέρυσι** (21.0%). Εισροή σεζόν 25/26: **112.5 ΕΚΜ**. Μεταφορά [Αρμίνου](/el/dam/arminou/)→[Κούρης](/el/dam/kouris/): **20.26 ΕΚΜ** από τον Οκτώβριο.

**Αξιοσημείωτα:**
- **[Αρμίνου](/el/dam/arminou/) 47.5%** — μικρή εισροή 0.045 ΕΚΜ/ημέρα παρά τη συνεχιζόμενη άντληση στον [Κούρη](/el/dam/kouris/)
- [Κούρης](/el/dam/kouris/) **41.9%** (48.2 ΕΚΜ) · [Γερμασόγεια](/el/dam/germasoyeia/) **60.0%** — σταθεροί κοντά στα μέγιστα σεζόν
- **[Μαυροκόλυμπος](/el/dam/mavrokolympos/) 83.2%** — σταθερή υποχώρηση καλοκαιριού από το μέγιστο
- [Εύρετου](/el/dam/evretou/) **50.0%** — παραμένει στο μισό, αργή κατακόρυφη μείωση
...
`;
  ...
  if (language === 'ru') {
    return `
### Последние изменения (29 мая — 10 июня 2026)

Общий запас **42.4%** (123.3 МКМ) — **12 дней подряд без изменений**: сухой сезон полностью вступил в силу. **+21.4пп выше прошлогодних** (21.0%). Приток сезона 25/26: **112.5 МКМ**. Перекачка [Арминоу](/ru/dam/arminou/)→[Курис](/ru/dam/kouris/): **20.26 МКМ** с октября.

**Основные изменения:**
- **[Арминоу](/ru/dam/arminou/) 47.5%** — небольшой приток 0.045 МКМ/день несмотря на продолжение перекачки в [Курис](/ru/dam/kouris/)
- [Курис](/ru/dam/kouris/) **41.9%** (48.2 МКМ) · [Гермасойя](/ru/dam/germasoyeia/) **60.0%** — стабильны у сезонных максимумов
- **[Мавроколимпос](/ru/dam/mavrokolympos/) 83.2%** — устойчивое летнее снижение от пика
- [Эвретоу](/ru/dam/evretou/) **50.0%** — держится на половине, медленный спад
...
`;
  ...
  return `
### Recent Changes (May 29 — June 10, 2026)

Total storage at **42.4%** (123.3 MCM) — **unchanged for 12 straight days** as the dry season fully takes hold. **+21.4pp above last year** (21.0%). Season total inflow: **112.5 MCM**. [Arminou](/dam/arminou/)→[Kouris](/dam/kouris/) transfer: **20.26 MCM** since October.

**Notable movements:**
- **[Arminou](/dam/arminou/) 47.5%** — 0.045 MCM/day inflow sustaining level despite ongoing pumping to [Kouris](/dam/kouris/)
- [Kouris](/dam/kouris/) **41.9%** (48.2 MCM) · [Germasoyeia](/dam/germasoyeia/) **60.0%** — steady near season highs
- **[Mavrokolympos](/dam/mavrokolympos/) 83.2%** — steady dry-season decline from peak
- [Evretou](/dam/evretou/) **50.0%** — holding at half capacity, slow drawdown
