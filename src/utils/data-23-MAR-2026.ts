...
Συνολική αποθήκευση **26.9%** (78.1 ΕΚΜ), αύξηση από 21.2% (61.6 ΕΚΜ) στις 13/3 — εξαιρετικές βροχοπτώσεις στον Τρόοδο. Τα αποθέματα **ξεπέρασαν το περσινό επίπεδο** (24.7%, 71.8 ΕΚΜ) για πρώτη φορά φέτος. Συνολική εισροή 25/26: 59.8 ΕΚΜ — 3.2× περισσότερο από όλη την ξηρή χρονιά 24/25 (18.7 ΕΚΜ). Μεταφορά Αρμίνου→Κούρης: 9.63 ΕΚΜ.

**Αξιοσημείωτα:**
- **Κούρης 24.3%** (27.9 ΕΚΜ), νέο μέγιστο σεζόν πάνω από πέρυσι (20.1%)
- **Ασπρόκρεμμος 29.4%** (15.42 ΕΚΜ) — ξεπέρασε το περσινό μέγιστο (15.35 ΕΚΜ)
- **Γερμασόγεια** σχεδόν διπλασιάστηκε: από 14.1% (20/3) σε 22.4% σε 3 ημέρες
- **Αρμίνου εκτοξεύθηκε** στο 56.6% (2.44 ΕΚΜ) — εισροή 2.46 ΕΚΜ σε 3ήμερο
- **Ταμασός 83.4%** (2.34 ΕΚΜ), πάνω από 2× πέρυσι (37.6%)
- Αχνα παραμένει κρίσιμα χαμηλά στο 2.1% (0.14 ΕΚΜ)
...
Общий запас **26.9%** (78.1 МКМ), рост с 21.2% (61.6 МКМ) на 13/3 — исключительные осадки на Троодосе. Запасы **превысили прошлогодний уровень** (24.7%, 71.8 МКМ) впервые в этом сезоне. Общий приток 25/26: 59.8 МКМ — в 3.2 раза больше всего засушливого сезона 24/25 (18.7 МКМ). Перекачка Арминоу→Курис: 9.63 МКМ.

**Основные изменения:**
- **Курис 24.3%** (27.9 МКМ) — новый сезонный максимум, выше прошлогоднего (20.1%)
- **Аспрокреммос 29.4%** (15.42 МКМ) — превысил прошлогодний пик (15.35 МКМ)
- **Гермасойя** почти удвоилась: с 14.1% (20/3) до 22.4% за 3 дня
- **Арминоу резко вырос** до 56.6% (2.44 МКМ) — приток 2.46 МКМ за 3 дня
- **Тамассос 83.4%** (2.34 МКМ), более чем вдвое превысил прошлый год (37.6%)
- Ахна остаётся критически низкой — 2.1% (0.14 МКМ)
...
Total storage at **26.9%** (78.1 MCM), up from 21.2% (61.6 MCM) on Mar 13 — exceptional Troodos rainfall. Reserves have **now exceeded last year's level** (24.7%, 71.8 MCM) for the first time this season. Total 25/26 inflow: 59.8 MCM — 3.2× the entire 2024/25 drought season (18.7 MCM). Arminou→Kouris transfer: 9.63 MCM since October.

**Notable movements:**
- **Kouris at 24.3%** (27.9 MCM) — new season high, now above last year (20.1%)
- **Asprokremmos at 29.4%** (15.42 MCM) — surpassed last year's peak (15.35 MCM)
- **Germasoyeia nearly doubled**: from 14.1% (Mar 20) to 22.4% in just 3 days
- **Arminou surged** to 56.6% (2.44 MCM) — 2.46 MCM inflow in the last 3-day period
- **Tamassos at 83.4%** (2.34 MCM), more than double last year (37.6%)
- Achna remains critically low at 2.1% (0.14 MCM)
